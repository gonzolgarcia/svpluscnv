...
circ.wg.plot <- function(seg,sv, 
  ...
  if(is.null(chr.list)) chr.list <- paste("chr",c(1:22,"X","Y"),sep="")
  ...
  circos.initializeWithIdeogram(species=genome.v, chromosome.index=chr.list, plotType=c("ideogram","labels"))
  text(0, 0,  gsub("_","\n",sample_id), cex = 1)
