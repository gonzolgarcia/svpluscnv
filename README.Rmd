...
* [Recurrently altered genes](#recurrently-altered-genes)
    ...
    * [Recurrently altered genes overlapping with structural variants calls](#recurrently-altered-genes-overlapping-with-structural-variants-calls)
    * [Integrated visualization of SVs and CNV of recurrently altered genes](#integrated-visualization-of-svs-and-cnv-of-recurrently-altered-genes)
...
shatt_lung <- shattered.regions(segdf, svdf, fc.pct = 0.05,  min.num.probes = 3, clean.brk = 4,
                                ...
                                dist.iqm.cut = 100000,verbose=TRUE)
...
### Integrated visualization of SVs and CNV of recurrently altered genes
...
```{r plot9,  fig.width=9, fig.height=12, fig.align='center', fig.cap = "Recurrently altered genes with overlapping SV breakpoints", message=FALSE}
...
par(mar=c(0,10,1,1))
sv.model.view(svdf, segdf, chr,start,stop, addlegend = 'both',addtext=c("TRA"),cnvlim = c(-2,2),cex.axis=1,text.size=.8)
gene.track.view(chr=chr ,start=start,stop=stop,addtext=TRUE)
```
